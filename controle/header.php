					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="default.php"><img src="img/logo.png" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											<li class="active"><a href="default.php">Home <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
							...
							<div class="col-lg-2 col-12">
								<div class="get-quote">
									<a href="/controle/login.php" class="btn">painel do cliente</a>
								</div>
							</div>
						</div>
					</div>
