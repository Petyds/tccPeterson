...
switch ($current_page) {
    ...
    case 'cadastrar_usuario.php':
        $title = "Cadastrar Usuário | Sistema de Hospital";
        break;
...
<head>
    ...
    <style>
        /* Estilos para o botão de Login no header */
        .header .get-quote1 .btn-login-icon {
            /* Garante que o botão esteja sempre visível e com layout flexível */
            opacity: 1 !important; 
            visibility: visible !important;
            display: inline-flex !important; /* Usar flexbox para alinhar ícone e texto */
            align-items: center; /* Centraliza verticalmente */
            justify-content: center; /* Centraliza horizontalmente */
            
            /* Estilos visuais do botão */
            padding: 10px 15px; /* Ajuste o padding conforme desejar */
        ...
        /* Estilo no hover para o botão de Login */
        .header .get-quote1 .btn-login-icon:hover {
            background-color: #0056b3; /* Cor de fundo mais escura no hover */
            text-decoration: none; /* Garante que não sublinhe no hover */
        }

        /* Espaçamento e tamanho do ícone dentro do botão de Login */
        .header .get-quote1 .btn-login-icon i {
            margin-right: 8px; /* Espaço entre o ícone e o texto */
            font-size: 18px; /* Tamanho do ícone */
        }

        /* REMOVER ESTA REGRA SE ELA ESTIVER CAUSANDO PROBLEMAS EM OUTROS BOTÕES */
        /* Esta regra foi a que você tinha, e pode ser a causa original do problema de display */
                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-12">
                            <div class="get-quote1">
                                <a href="<?php echo $base_url; ?>/controle/login.php" class="btn-login-icon">
